...
{#if mode === "design"}
    <section class="relative bg-black text-white">
      ...
      " />
                ...
                <!-- Formes décor (gris clair), AU-DESSUS du SVG -->
                ...
                <!-- Photo, au-dessus de tout -->
                <img
                        src={portraitDesign}
                        alt="Jade-Keina"
                        class="absolute z-10 left-1/2 -translate-x-1/2 -bottom-6 w-[28rem] lg:w-[34rem] object-cover"
                />
            </div>

            <!-- petit footer noir pour “fermer” la compo comme sur la maquette -->
            <div class="h-6 bg-black mt-6"></div>
        </div>
    </section>
...
{:else}
    <section class="relative min-h-screen bg-[#EFE6E3] text-gray-900 flex flex-col items-center justify-center px-6">
        ...
        <img src={portrait} alt="Moi" class=" absolute w-[45em] rounded-xl z-5" />
